...
CMD xvfb-run -a -e display.log java -jar osbot.jar -login SantiagoDunbar:rRYGJ@yy7Tu7xg3 -script BottifyClient:"${BotID}" -bot ${RS_USERNAME}:${RS_PASSWORD}:0000 -proxy us3943.nordvpn.com:1080:mkeown42@gmail.com:t5^EC@SDca.?ZM9 -world 308 -debug 5005 -allow nointerface lowcpu norandoms
