...
CMD xvfb-run -a -e display.log java -jar osbot.jar -login SantiagoDunbar:rRYGJ@yy7Tu7xg3 -script BottifyClient:"${BotID}" -bot ${RS_USERNAME}:${RS_PASSWORD}:0000 -world 308 -debug 5005 -allow nointerface lowcpu
